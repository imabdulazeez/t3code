...
import Migration0032 from "./Migrations/032_ProjectionThreadProposedPlanRevertedAt.ts";
import Migration0033 from "./Migrations/033_RepairAuthAuthorizationScopes.ts";
import Migration0034 from "./Migrations/034_AuthPairingProofKeyThumbprint.ts";
import Migration0035 from "./Migrations/035_ProjectionThreadsSettled.ts";
import Migration0036 from "./Migrations/036_ProjectionThreadsSnoozed.ts";
...
export const migrationEntries = [
  ...
  [32, "ProjectionThreadProposedPlanRevertedAt", Migration0032],
  [33, "RepairAuthAuthorizationScopes", Migration0033],
  [34, "AuthPairingProofKeyThumbprint", Migration0034],
