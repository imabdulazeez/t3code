...
export function setThreadChangedFilesExpanded(
  ...
  // When the choice matches the effective default, drop the per-turn override so
  // the turn keeps following the default; otherwise persist the explicit boolean.
