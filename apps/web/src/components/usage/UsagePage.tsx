...
export function UsagePage({ initialMetric }: { readonly initialMetric?: UsageMetric | undefined }) {
  const [preferences, setPreferences] = useState(readUsagePagePreferences);
  // A `?metric=` deep link wins until the reader picks a tab; after that the
  // remembered selection takes over again.
  const [deepLinkMetric, setDeepLinkMetric] = useState(initialMetric);
