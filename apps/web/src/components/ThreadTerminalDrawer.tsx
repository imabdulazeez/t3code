...
export function TerminalViewport({
  ...
  const ownerKey = terminalOwnerKey(ownerRef);
  ...
  }, [cwd, environmentId, runtimeEnv, terminalId, ownerKey]);
  ...
  }, [drawerHeight, environmentId, owner, resizeEpoch, terminalId, ownerKey]);
  return (
    <div
      ref={containerRef}
