...
export function buildProviderInstanceUpdatePatch(input: {
  ...
  readonly textGenerationModelSelection?:
    ...
    | undefined;
  readonly textGenerationFallbackModelSelection?:
    | ServerSettings["textGenerationFallbackModelSelection"]
    | undefined;
  ...
  return {
    ...
    ...(input.textGenerationModelSelection !== undefined
      ...
      : {}),
    ...(input.textGenerationFallbackModelSelection !== undefined
      ? { textGenerationFallbackModelSelection: input.textGenerationFallbackModelSelection }
      : {}),
  };
}
