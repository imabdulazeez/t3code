...
function AssistantChangedFilesSectionInner({
  ...
  const changedFilesExpandedByDefault = useClientSettings((s) => s.changedFilesExpandedByDefault);
  ...
  // Precedence: explicit per-turn state wins; otherwise the user's expand-by-default
  // preference when enabled, else upstream's latest-turn auto-expand heuristic.
  const expandedByDefault = changedFilesExpandedByDefault || (isLatestTurn && autoExpanded);
  const expanded = persistedExpanded ?? expandedByDefault;
  ...
  return (
    <ChangedFilesCard
      ...
      onExpandedChange={(nextExpanded) =>
        setExpanded(routeThreadKey, turnSummary.turnId, nextExpanded, expandedByDefault)
      }
