...
export default function GitActionsControl({
  ...
  const autoCreatePrOnPush = useClientSettings((s) => s.autoCreatePrOnPush);
      ...
      {repositoryWebUrl === null ? (
        <Popover>
          ...
          >
            ...
            >
              <ExternalLinkIcon />
              <MenuItemLabel>Open repository</MenuItemLabel>
            </MenuItem>
          </PopoverTrigger>
          <PopoverPopup tooltipStyle side="left" align="center">
        ...
        <MenuItem density={presentation === "menu" ? "touch" : "default"} onClick={openRepository}>
          <ExternalLinkIcon />
          <MenuItemLabel>Open repository</MenuItemLabel>
        </MenuItem>
      )}
