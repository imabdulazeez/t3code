...
export const LOCAL_UPDATE_SET_CLEANUP_ENABLED_CHANNEL = "desktop:local-update-set-cleanup-enabled";
...
export const LOCAL_UPDATE_ROLLBACK_CHANNEL = "desktop:local-update-rollback";
export const LOCAL_UPDATE_REVEAL_FOLDER_CHANNEL = "desktop:local-update-reveal-folder";
