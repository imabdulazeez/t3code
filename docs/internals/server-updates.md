...
Desktop-managed servers do not update remotely. Clients direct the user to update
the desktop app on that machine, which brings its bundled backend along.
