...
import {
  ...
  type PromoteThreadProposedPlanInput,
...
export type {
  ...
  PromoteThreadProposedPlanInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    promoteProposedPlan: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:promote-proposed-plan",
      execute: (input: PromoteThreadProposedPlanInput) => promoteThreadProposedPlan(input),
      scheduler,
      concurrency,
    }),
    revertProposedPlan: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:revert-proposed-plan",
      execute: (input: RevertThreadProposedPlanInput) => revertThreadProposedPlan(input),
      scheduler,
      concurrency,
    }),
  };
