...
const WsServerPullSettingsGistRpc = Rpc.make(WS_METHODS.serverPullSettingsGist, {
...
const WsServerPushSettingsGistRpc = Rpc.make(WS_METHODS.serverPushSettingsGist, {
